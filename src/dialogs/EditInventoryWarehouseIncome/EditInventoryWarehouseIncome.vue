                        ...
                        <section slot="content">
                            ...
                            <ion-list>
                                <ion-item button  @click="(e) => {actions.openJobSelector(); e.stopPropagation()}">
                                    <ion-input :disabled="isReadonly" :readonly="true" label="Job:" label-placement="stacked" placeholder="Selecciona el Job" v-model="warehouseIncome.job_code"></ion-input>
                                </ion-item>
                                <ion-item  button @click="(e) => {actions.openExpenseSelector(); e.stopPropagation()}">
                                    <ion-input :disabled="isReadonly" :readonly="true" label="Expense:" label-placement="stacked" placeholder="Selecciona el Expense" v-model="warehouseIncome.expense_code"></ion-input>
                                </ion-item>
                            </ion-list>
                        </section>
                    </ion-accordion>
