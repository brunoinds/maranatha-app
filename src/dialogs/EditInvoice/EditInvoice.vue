                    ...
                    <ion-accordion value="second">
                        ...
                        <section slot="content">
                            <ion-list>
                                ...
                                <ion-item>
                                    <ion-input :readonly="readonly" label="RUC:" label-placement="stacked" placeholder="XXXXXXXXXXX" v-model="invoice.commerce_number"  inputmode="numeric" type="tel"></ion-input>
                                </ion-item>
                            </ion-list>
                        </section>
                    </ion-accordion>
