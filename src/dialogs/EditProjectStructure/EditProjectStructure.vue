                                ...
                                <ion-card slot="content" :style="{margin: 0}">
                                    <ion-card-content :style="{padding: 0}">
                                        <ion-list>
                                            ...
                                            <ion-item-choose-dialog @click="openExpenseSelector(phase)" placeholder="Selecciona el Expense" label="Expense code:" :value="phase.expense_code"/>
                                            <ion-item>
...
import { IonAccordion, IonAccordionGroup, IonButton, IonButtons, IonCard, IonCardContent, IonCardHeader, IonCardTitle, IonContent, IonHeader, IonIcon, IonInput, IonItem, IonLabel, IonList, IonListHeader, IonPage, IonProgressBar, IonSelect, IonSelectOption, IonTitle, IonToolbar, alertController, toastController } from '@ionic/vue';
...
const openExpenseSelector = (phase: IDefaultConstructionPhase) => {
    Dialog.show(ExpenseSelector, {
        props: {
            selectedExpenseCode: phase.expense_code
        },
        onLoaded($this) {
            $this.on('selected', (event:any) => {
                const expense = event.data;
                phase.expense_code = expense.code;
            })
